...
public class FlyTabView extends View {
    ...
    public FlyTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //获取所有的自定义属性
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FlyTabView);
        BitmapDrawable iconNormal = (BitmapDrawable) a.getDrawable(R.styleable.FlyTabView_tabIconNormal);
        if (iconNormal != null) {
            mIconNormal = iconNormal.getBitmap();
        }
        BitmapDrawable iconSelected = (BitmapDrawable) a.getDrawable(R.styleable.FlyTabView_tabIconSelected);
        ...
        mText = a.getString(R.styleable.FlyTabView_tabText);
        mTextSize = a.getDimensionPixelSize(R.styleable.FlyTabView_tabTextSize, mTextSize);
        mTextColorNormal = a.getColor(R.styleable.FlyTabView_textColorNormal, mTextColorNormal);
        mTextColorSelected = a.getColor(R.styleable.FlyTabView_textColorSelected, mTextColorSelected);
        mBadgeBackgroundColor = a.getColor(R.styleable.FlyTabView_badgeBackgroundColor, mBadgeBackgroundColor);
        mPadding = (int) a.getDimension(R.styleable.FlyTabView_paddingTexwithIcon, mPadding);
        a.recycle();
        initText();
    }
